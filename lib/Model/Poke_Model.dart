...
class Pokemon {
  ...
  Pokemon.fromJson(Map<String, dynamic> json) {
    ...
    // Handle next_evolution as a list of objects
    ...
    // Handle prev_evolution with error handling for unexpected data
    if (json['prev_evolution'] != null) {
      ...
      } else if (json['prev_evolution'] is Map) {
        prevEvolution = [PrevEvolution.fromJson(json['prev_evolution'])];
      }
    }
  }
